export default function SelectbyName(props) {
  return (
    <div>
      <div class=" dark:border-white dark:text-black rounded-md flex w-full items-center border border-2 border-black p-2">
        <svg class="w-6 h-6 text-gray-400 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input  value={props.value} onChange={(e) => props.change(e)} type="text" class="p-2 flex-grow bg-white dark:bg-dark_white focus:outline-none" placeholder="Qué calle?"></input>
      </div>
